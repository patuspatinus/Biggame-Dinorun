...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        while(Play_Again){
                ...
                GenerateEnemyChar(enemy2,enemy1,gEnemyClips2,gEnemyClips1,gRenderer);

                SpecialFruit Immune(IN_AIR_ENEMY);
                SpecialFruit Mutant(IN_AIR_ENEMY);

                GenerateSpecialFruit(Immune,gSpecialFruit,Mutant,gGiantFruit,gRenderer);
                        ...
                        if (loadCharacter(type)){
                                if (Continue_game){
                                    ...
                                    while(SDL_PollEvent(&ev) != 0){
                                        ...
                                        Character.HandleEvent(ev, gJump, mute);
                                    }
                                    ...
                                    if (Immune.GetPosX() < 0 && (specialfruitappear2 == false)){
                                        immuneappear += 400;
                                    ...
                                    if (immune){
                                        UpdateSpecialFruitTime(specialfruittime, speedincrease, immune);
                                    ...
                                    if (!immune){
                                        if (checkcollision1(Character,currentClip,enemy2,currentClip_Enemy2) || checkcollision2(Character,currentClip,enemy1,currentClip_Enemy1)){
                                            Mix_PauseMusic();
