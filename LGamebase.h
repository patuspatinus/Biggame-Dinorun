...
bool checkcollision3(Character Character, SDL_Rect* a,Enemy enemy3, SDL_Rect* b){
    int leftA, leftB;
    int rightA, rightB;
    int topA, topB;
    int bottomA, bottomB;
    ...
    //Calculate the sides of rect B
    leftB = enemy3.GetPosX();
    rightB = enemy3.GetPosX() + 60;
    topB = enemy3.GetPosY();
    bottomB = enemy3.GetPosY() + 64;
...
bool checkcollision4(Character Character, SDL_Rect* a,Enemy enemy4, SDL_Rect* b){
    int leftA, leftB;
    int rightA, rightB;
    int topA, topB;
    int bottomA, bottomB;
    ...
    //Calculate the sides of rect B
    leftB = enemy4.GetPosX();
    rightB = enemy4.GetPosX() + 60;
    topB = enemy4.GetPosY();
    bottomB = enemy4.GetPosY() + 64;
...
bool checkcollisionTinyFruit(Character Character, SDL_Rect* a,SpecialFruit Tiny, SDL_Rect* b){
    int leftA, leftB;
    int rightA, rightB;
    int topA, topB;
    int bottomA, bottomB;
    ...
    //Calculate the sides of rect B
    leftB = Tiny.GetPosX();
    rightB = Tiny.GetPosX() + 40;
    topB = Tiny.GetPosY();
    bottomB = Tiny.GetPosY() + 40;
	...
	SDL_Renderer * gRenderer)
{
    ...
    enemy3.LoadFromFile("rocket1.png", gRenderer);
	{
		gEnemyClips3[0].x = 0;
		gEnemyClips3[0].y = 0;
		gEnemyClips3[0].w = 64;
	...
	enemy4.LoadFromFile("rocket1.png", gRenderer);
	{
	    gEnemyClips4[0].x = 0;
		gEnemyClips4[0].y = 0;
		gEnemyClips4[0].w = 64;
...
void GenerateSpecialFruit(SpecialFruit& Immune,
    ...
    SpecialFruit& Tiny,
    SDL_Rect (&gSpecialFruit3)[SPECIALFRUIT_ANIMATION],
    SDL_Renderer *gRenderer)
{
    ...
    Tiny.LoadFromFile("Tinyfruit.png", gRenderer);
    {
        gSpecialFruit3[0].x = 0;
        gSpecialFruit3[0].y = 0;
        gSpecialFruit3[0].w = 40;
        gSpecialFruit3[0].h = 40;
    }
}
